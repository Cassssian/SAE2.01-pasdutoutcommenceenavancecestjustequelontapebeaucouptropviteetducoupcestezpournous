...
namespace VraiPseudoSae.view.RLS_Pages
{
    public class RLSGame : Game
    {
        ...
        {
            Car1.VX = 0; Car1.VY = 0; Car1.OnGround = true;
            Car1.JumpsLeft = 2; Car1.JumpKeyPrev = false; Car1.Boost = 100;
            Car1.FacingDir = 1;       // setter applique ChangeScale + PutXY
            Car1.PutPosition(150, 482);

            Car2.VX = 0; Car2.VY = 0; Car2.OnGround = true;
            Car2.JumpsLeft = 2; Car2.JumpKeyPrev = false; Car2.Boost = 100;
            Car2.FacingDir = -1;      // idem
